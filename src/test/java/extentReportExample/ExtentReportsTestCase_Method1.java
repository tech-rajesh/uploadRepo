...
public class ExtentReportsTestCase_Method1 {
	...
	public void startReport() {
		...
		htmlReporter = new ExtentHtmlReporter("./test-output/IBM_14July_ExtentReport"+dateName_number+".html");
		...
		htmlReporter.config().setDocumentTitle("Capgemini Functional Automation/API Report");
		// Name of the report
	...
	public void verifyLogo() {
		...
		Assert.assertFalse(img); //failing test case
	}
