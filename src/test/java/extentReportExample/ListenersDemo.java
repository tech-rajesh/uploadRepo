...
public class ListenersDemo extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("LT Automation Report"); // Title of report
		htmlReporter.config().setReportName("LT Functional Automation Testing Report"); // name of the report
		...
		extent.setSystemInfo("Project Name","LT Automation");
